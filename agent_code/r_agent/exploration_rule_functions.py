...
def coin_collector_rules(self, game_state):
    ...
    # valids = []
    # encoded_action_map = DQNAgent.action_to_encoded()
    # for action in valid_actions:
    #     if action in encoded_action_map:
    #         valids.append(action)
    # self.logger.debug(f'Valids: {valids} and encoded_action_map: {encoded_action_map}')

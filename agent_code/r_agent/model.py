...
import random
import math
from agent_code.r_agent.callbacks import get_valid_probabilities_list
...
class DQNAgent:
    ...
    def build_model(self):
        model = Sequential()
        model.add(Conv2D(16, input_shape=self.state_size, kernel_size=(5, 5), padding="same", activation="relu"))
